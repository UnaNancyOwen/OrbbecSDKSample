...
inline void orbbec::initialize_sensor()
{
    ...
    try{
        color_stream_profile = color_stream_profile_list->getVideoStreamProfile( 1280, 720, OBFormat::OB_FORMAT_BGRA, 30 );
    }
    catch( ob::Error& e ){
    ...
    try{
        depth_stream_profile = depth_stream_profile_list->getVideoStreamProfile( 1280, 720, OBFormat::OB_FORMAT_Y16, 30 );
    }
    catch( ob::Error& e ){
